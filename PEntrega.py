    ...
    def WriteStrings():
        ...
        if not ("main" in typeTable.keys()):
            ...
            for string in strings:
                ...
                contador += 1
            for globalVar in GlobalVarSize.keys():
                Node.WriteGlobalVar(globalVar, GlobalVarSize[globalVar], 4)
        ...
        if local_EBPoffsetTable is None:
            ...
            while isinstance(self.lval, NodeArray):
                ...
                if isinstance(self.lval.indxVal, NodeNum):
                    ...
                    NodeError("Array size must be kown at compile time!")

                self.lval = self.lval.refNode

            if self.idname in GlobalVarSize:
                ...
                GlobalVarSize[self.lval] = varSize
